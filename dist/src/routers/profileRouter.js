...
profileRouter.put("/update", authentication_1.default, // Pastikan pengguna sudah login
uploads_1.default, // Menggunakan multer untuk menangani upload file (gambar profil)
